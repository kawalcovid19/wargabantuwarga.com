...
describe("App", () => {
  ...
  it("renders correctly", () => {
    const { container } = render(
      <App Component={() => <div />} pageProps={{}} router={fakeRouter} />,
    );
...
<main
  class="flex flex-col w-full min-h-screen bg-gray-100"
>
  <header
  ...
  <div />
  <button
    class="hidden fixed bottom-20 right-5 h-12 w-12 items-center justify-center p-2 border border-transparent rounded-full shadow-lg text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-300 ease-in-out z-30"
  >
    <svg
      class="h-6 w-6"
      fill="none"

...
>
  <button
    ...
    class="inline-flex px-4 py-2 text-sm rounded-md items-center border border-transparent font-medium text-blue-700 bg-blue-100 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:cursor-not-allowed disabled:opacity-75 relative z-10"
    type="button"
  >
    <svg
      aria-hidden="true"

...
### Mengapa kalian menggunakan bahasa Inggris dalam menulis _issue_ dan _pull request_?

Ada beberapa alasan mengapa kita menggunakan bahasa Inggris ketika berkomunikasi di dalam _issue_ dan _pull request_:

1. Secara alamiah, lebih mudah untuk _software engineer_ berkomunikasi dalam bahasa Inggris, karena terminologi-terminologi teknis yang digunakan dalam pemrograman pun berbahasa Inggris. Apabila kita mencoba menerjemahkannya, akan meningkatkan resiko miskomunikasi. Sementara itu, apabila kita tidak menerjemahkan terminologi tersebut, kita harus lebih banyak menggunakan _teks miring_ agar sesuai dengan pedoman-pedoman [PUEBI](https://puebi.js.org/huruf/miring).

...
export const latestNews: LatestNewsItem[] = [
  ...
  },
  {
    ...
    html: "<p>Kementerian Kesehatan meluncurkan SIRANAP terbaru versi 3.0. Melalui SIRANAP 3.0, kita dapat memeriksa <strong>ketersediaan IGD di seluruh Indonesia</strong>. Khusus untuk wilayah Jakarta ketersediaan IGD diperbarui setiap 3 jam sekali oleh para relawan lapangan.</p>",
  },
];
